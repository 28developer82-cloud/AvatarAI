...
class ChatSection(QWidget):
    ...
    def __init__(self):
        ...
        self.setStyleSheet("""
            ...
            QScrollBar::up-arrow:vertical, QScrollBar::down-arror:vertical {
            border: none;
            background: none;
            color: none;
            }
...
class InitialScreen(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        max_gif_size_H = int(screen_width / 15 * 10)
        ...
        content_layout.setContentsMargins(0, 0, 0, 75)
...
class CustomTopBar(QWidget):
    ...
    def showMessageScreen(self, event):
